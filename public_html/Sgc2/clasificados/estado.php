...
$id_cat=$_GET['id_cat'];
  ...
  $updateSQL =sprintf("UPDATE categoria_clasificado SET Estado_CatCla = '$esta' WHERE Id_CategoriaClasificado=%d",
  ...
  $id_cat= $_GET['id_cat'];
  $updateSQL2 = "UPDATE clasificados,categoria_clasificado SET Estado_Cla= '$esta' WHERE categoria_clasificado.Id_CategoriaClasificado= '$id_cat'
                 AND clasificados.IdCategoriaCla_Cla= categoria_clasificado.Id_CategoriaClasificado ";
  mysql_select_db($database_cnx_arica, $cnx_arica);
...
<?
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsCategoria = "SELECT * FROM categoria_clasificado where Id_CategoriaClasificado= '$id_cat'";
