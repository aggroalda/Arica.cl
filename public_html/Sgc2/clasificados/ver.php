      ...
      <tr>
        <td valign="middle"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td colspan="2" background="../../0_SOURCE/SGC_INTERNET/img/cdo_top_fnd.jpg"></td>
            <td width="11"><img src="../../0_SOURCE/SGC_INTERNET/img/cdo_top_der.jpg"/></td>
          </tr>
          <tr>
            <td rowspan="2" background="../../0_SOURCE/SGC_INTERNET/img/cdo_izq_fnd.jpg"></td>
...
<?php if ($totalRows_rsFotos > 0) {
                  ...
                  <p><strong>___________________<br>
                    <a href="../../0_SOURCE/SGC_INTERNET/clasificados/imagenes.php?cantidad=1&id_pro=<?php echo $row_rsProducto['Id_Productos']; ?>" class="linksRojo"> <br>
                      [+] Agregar Imagen</a></strong></p>
                  &nbsp;</td>
              </tr>
            </table></td>
            <td rowspan="2" background="../../0_SOURCE/SGC_INTERNET/img/cdo_der_fnd.jpg"></td>
          </tr>
          <tr>
            <td height="11" colspan="2" align="left" bgcolor="#EBEBEB"><a href="../../0_SOURCE/SGC_INTERNET/clasificados/editar.php?id_pro=<?php echo $row_rsProducto['Id_Productos']; ?>" class="fuente linksRojo"><strong>EDITAR ESTE PRODUCTO</strong></a></td>
            </tr>
          <tr>
            <td height="11"><img src="../../0_SOURCE/SGC_INTERNET/img/cdo_dwn_izq.jpg" width="11" height="11"/></td>
            <td colspan="2" background="../../0_SOURCE/SGC_INTERNET/img/cdo_dwn_fnd.jpg"></td>
            <td><img src="../../0_SOURCE/SGC_INTERNET/img/cdo_dwn_der.jpg" width="11" height="11"/></td>
          </tr>
        </table>
          <blockquote>
          <p><a href="../../0_SOURCE/SGC_INTERNET/clasificados/agregar.php" class="fuente linksRojo"><strong>[+] Agregar Nuevo Producto</strong></a></p>
          <p><a href="../../0_SOURCE/SGC_INTERNET/clasificados/index.php" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Productos</strong></a></p>
