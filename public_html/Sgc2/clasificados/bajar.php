...
// bajar orden del menu
    ...
    $ordenBajar = $_GET['orden'] + 1;  
			...
			$query_rscategoria_clasificado = "SELECT * FROM categoria_clasificado WHERE Orden_CatCla= ".$ordenBajar;
    ...
    mysql_select_db($database_cnx_arica, $cnx_arica);
     mysql_query("UPDATE categoria_clasificado SET Orden_CatCla = $ordenBajar
