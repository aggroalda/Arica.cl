...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsOrden = "SELECT max(Orden_CatCla) FROM categoria_clasificado";
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Categor&iacute;a de Clasificado - Agregar</p>
          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td bgcolor="#EBEBEB"><form action="" method="POST" enctype="multipart/form-data" name="form1" target="frameSave"  id="form1">
                <table width="100%">
                  <tr>
                    <td width="46%" align="right" class="fuente"><strong>Categor&iacute;a de Clasificado:</strong></td>
                    <td width="54%">
                     
                      <input type="text" name="nombre_Txt" id="nombre_Txt" title="Nombre de Categoría">
