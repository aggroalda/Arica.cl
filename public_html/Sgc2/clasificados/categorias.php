        ...
        <table width="100%" align="center" class="bordes2" >
          ...
          <tbody class="tabla">
            ...
            <tr class="odd">
              ...
              <td align="center"><a href="../categorias/subeditar.php?id_cat=<? echo $row_rsCategoria['Id_Categoria']?>&id_sub=<?php echo $row_rsSubcategoria['Id_Subcategoria']; ?>"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
