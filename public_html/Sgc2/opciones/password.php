...
function verify() {
var actual=document.getElementById('actual_Txt').value;
var nueva=document.getElementById('nueva_Txt').value;
var repetir=document.getElementById('repetir_Txt').value;
...
<body onLoad="document.form1.actual_Txt.focus();">
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Opciones Generales - Actualizar Contrase&ntilde;a</p>
      ...
      <tr>
        <td valign="middle"><table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr><td background="../img/cdo_izq_fnd.jpg"></td>
            <td bgcolor="#EBEBEB"><form  method="GET" action="" name="form1" id="form1">
              <table width="100%">
                <tr><input type="hidden" value="<?=$usuario;?>" id="usuario" name="usuario">
                  <td colspan="2" align="center" class="fuente" id="tdR"> <? include("cambiar.php");?></td>
                </tr>
                <tr>
                  <td width="45%" align="right" class="fuente"><strong>Contrase&ntilde;a Actual:</strong></td>
                  <td width="55%"><input name="actual_Txt" type="password" class="fuente" id="actual_Txt" onKeyPress="verify();">
                 </td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Nueva Contrase&ntilde;a:</strong></td>
                  <td><input name="nueva_Txt" type="password" class="fuente" id="nueva_Txt" onKeyPress="verify();"></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Repetir Contrase&ntilde;a:</strong></td>
                  <td><input name="repetir_Txt" type="password" class="fuente" id="repetir_Txt" onKeyPress="verify();"></td>
                </tr>
                <tr>
                  <td colspan="2" align="center">
                    <input name="btnGuardar" type="button" id="btnGuardar" onClick="cambiar();" value=" Cambiar " disabled="disabled"></td>
                </tr>
              </table>
            </form></td>
            <td width="21" background="../img/cdo_der_fnd.jpg"></td>
          </tr>
          <tr>
