...
$totalRows_rsRubroE = mysql_num_rows($rsRubroE);
	?>
    <blockquote>
            <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../rubros/index.php">M&oacute;dulo Rubro de Empresa</a> / <a id="guia_titulos" href="../empresas/index_get_rubro.php?id_rub_rub=<?php echo $_GET['id_rub_rub']; ?>">Categor&iacute;a <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?></a> /  <a id="guia_titulos" href="#">Editar</a></p></strong>
      <p class="titles">&raquo; Categor&iacute;a <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?> / Editar</p>
...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span>    
                   ...
                   <tr>
                    ...
                    <td align="left">
                    <select name="rubro" class="fuente" id="rubro"  title="Nombre tIPO">
                   ...
                   <tr>
                    ...
                    <td colspan="2" align="center"><input name="id_pro" type="hidden" id="id_pro" value="<?php echo $row_rsProductos['Id_Empresa']; ?>">
                      <input name="SendForm" type="submit" id="SendForm" onClick="MM_validateForm('categoria_Txt','','R','nombre_Txt','','R','largo_Txt','','R', 'ancho_Txt','','R', 'alto_Txt','','R','precio_Txt','','R');return document.MM_returnValue" value=" Guardar "></td>
                  </tr>
                </table>
          ...
          <p><a href="index_get_rubro.php?id_rub_rub=<? echo $_GET['id_rub_rub']; ?>" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Empresas / Categor&iacute;a <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?></strong></a></p>
