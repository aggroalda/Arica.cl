...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $descripcionfoto= $_POST['descripcion_Txt'];
			 ...
			 $insertSQL = sprintf("INSERT INTO empresa (Nombre_Emp, Foto_Emp, Descripcion_Emp, Ciudad_Emp, Direccion_Emp, Telefono_Emp, Correo_Emp, IdUsuario_Emp, Id_Rubro_Empresa) VALUES ( %s,%s,%s,%s,%s,%s,%s,%s,%s)",
...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span></td>
        		   ...
        		   <tr>
                    ...
                    <td align="left"><select name="rubro" class="fuente" id="rubro"  title="Nombre tIPO">
