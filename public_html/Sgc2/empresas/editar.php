...
$updateSQL = sprintf("UPDATE empresa SET Nombre_Emp=%s ,Foto_Emp=%s, Descripcion_Emp=%s,Ciudad_Emp=%s, Direccion_Emp=%s, Telefono_Emp=%s, Correo_Emp=%s,Id_Rubro_Empresa=%s WHERE Id_Empresa=%s",
...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsTipo3 = "SELECT * FROM empresa_rubro ORDER BY Id_Rubro";
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <strong>
      <p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../empresas/index.php">M&oacute;dulo de Empresa</a> / <a id="guia_titulos" href="../empresas/ver.php?id_pro=<? echo $_GET['id_pro'];?>">Detalles</a> / <a id="guia_titulos" href="#">Editar</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo de Empresa / Detalles / Editar</p>
              ...
              <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <td><input name="nombre_Txt" type="text" class="fuente" id="nombre_Txt" title="El campo Nombre" value="<?php echo utf8_encode($row_rsProductos['Nombre_Emp']); ?>" size="35"></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input title="El campo Foto" name="foto_Txt" type="file" class="fuente" id="foto_Txt">
                  ...
                  <tr>
                    ...
                    <td><textarea title="El campo Descripción" name="descripcion_Txt" cols="45" rows="3" class="fuente" id="descripcion_Txt" onkeyup="mostrarResultado(this.value,140,'spcontando');contarCaracteres(this.value,140,'sprestante')"><? echo utf8_encode($variable);?></textarea>
                    <br />
...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span>    
                   ...
                   <tr>
                    ...
                    <td align="left"><select name="rubro" class="fuente" id="rubro"  title="El campo Rubro">
