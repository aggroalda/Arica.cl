...
$msg = "<!DOCTYPE html><html><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><title>arica.cl | El verdadero portal de Arica</title><head><body>
	...
	<h4>".$titulo_not."</h4>
	<p>".$desarrollo_not."</p>
	<p align='justify'>Se agreg&oacute; una nueva noticia, para verla completa y realizar alguna operación debe hacer click en el siguiente enlace:</p>
	<ul>
 ...
 header("Location: imagenes_get_categoria.php?id_not=".$id_not."&cantidad=".$_POST['cantidad_Txt']."&tipo=1");
...
?>
  ...
  <tr>
    <td><blockquote>
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../categorias/index.php">M&oacute;dulo de Categor&iacute;a de Noticia</a> / <a id="guia_titulos" href="../novedades/index_get_categoria.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>"> Categor&iacute;a <? echo utf8_encode($row_rsTipo['Nombre_Cat']); ?></a> / <a id="guia_titulos" href="../novedades/index_get_categoria.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>">Listado</a></p></strong>
      <p class="titles">&raquo; Categor&iacute;a <? echo utf8_encode($row_rsTipo['Nombre_Cat']); ?> / Agregar</p>
      ...
      <tr>
        <td valign="middle"><blockquote>
              ...
              <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                <table width="100%">
                  ...
                  <tr>
                   ...
                   <option value="<? echo $row_rsTipo['Id_Categoria']?>"><? echo $row_rsTipo['Nombre_Cat']?></option>
                   </select>
                    </td>
                  </tr>
          ...
          <p><a href="javascript:cargar('noticiapagina_get_categoria.php?id_cat_cat=<? echo $_GET['id_cat_cat'];?>','tbnoticia')" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Noticia / Categor&iacute;a <? echo $row_rsTipo['Nombre_Cat']?></strong></a></p>
