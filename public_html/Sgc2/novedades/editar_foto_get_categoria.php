...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../categorias/index.php">M&oacute;dulo de Categor&iacute;a de Noticia</a> / <a id="guia_titulos" href="../novedades/index_get_categoria.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>"> Categor&iacute;a <? echo utf8_encode($row_rsCategoriaNot['Nombre_Cat']);?></a> / <a id="guia_titulos" href="ver_get_categoria.php?id_not=<? echo $_GET['id_not'];  ?>"> Detalles </a> </p></strong>
      <p class="titles">&raquo; Categor&iacute;a <? echo utf8_encode($row_rsCategoriaNot['Nombre_Cat']); ?> / Detalles / Editar Fotos</p>
      ...
      <tr>
        <td valign="middle">
          <table width="84%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <td bgcolor="#EBEBEB"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><label>
                      <textarea name="descripcion_gal" cols="45" rows="5" class="fuente" id="descripcion_gal" title="Descripci�n"><?php echo utf8_encode($row_rsGaleria['Descripcion_Gal']); ?></textarea>
                    </label></td>
                  </tr>
                  <tr>
            ...
            <blockquote>
              <p>&nbsp;</p>
              <p><a href="ver_get_categoria.php?id_not=<? echo $_GET['id_not'];  ?>" class="fuente linksRojo"><strong>&laquo; Volver a Detalle de Noticia / Categor&iacute;a <? echo utf8_encode($row_rsCategoriaNot['Nombre_Cat']);?></strong></a></p>
              <p><a href="index_get_categoria.php?id_cat_cat=<? echo $row_rsCategoriaNot['Id_Categoria'];?>" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Noticia / Categor&iacute;a <? echo utf8_encode($row_rsCategoriaNot['Nombre_Cat']);?> </strong></a></p>
