...
?>
  ...
  <tr>
    <td><blockquote>
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../clasificados/index.php">M&oacute;dulo Categoria de Clasificado</a> / <a id="guia_titulos" href="../articulos_clasificados/index_get_cat.php?id_cat_cat=<? echo $_GET['id_cat_cat'];?>">Anuncios Clasificados por <? echo utf8_encode($row_rsConsultaClasificados['Nombre_CatCla']);?></a>  / <a id="guia_titulos"href="#">Listado</a></p></strong>
        <p class="titles">&raquo; Anuncios Clasificados por <? echo utf8_encode($row_rsConsultaClasificados['Nombre_CatCla']);?> / Listado</p>
...
<td align="center" class="fuente" > <a id="subrayado_cat_not" href="javascript:cargar('../articulos_clasificados/noticiapagina_get_cat.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>&id_tip=<? echo $row_rsConsultaClasificados['IdCategoriaCla_Cla'] ?>','tbnoticia')"><? echo utf8_encode($row_rsConsultaClasificados['Nombre_CatCla']);?></a></td>
 <td align="center" class="fuente" ><a id="subrayado_cat_not" href="javascript:cargar('../articulos_clasificados/noticiapagina_get_cat.php?id_sub_tip=<? echo $row_rsConsultaClasificados['Id_Clasificados'] ?>','tbnoticia')"><? echo utf8_encode($row_rsConsultaClasificados['titulo_clasificado']);?></a></td>                
              ...
              <td align="center"><a href="editar_get_cat.php?&id_cat_cat=<? echo $_GET['id_cat_cat'];?>&id_art=<?php echo $row_rsConsultaClasificados['Id_Articulo']; ?>"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
              <td align="center"><a href="javascript:preguntarArticulos2('<?php echo $row_rsConsultaClasificados['Id_Articulo']; ?>','<?php echo $row_rsConsultaClasificados['titulo_clasificado']; ?>','<? echo utf8_encode($row_rsConsultaClasificados['Id_Clasificados']);?>')"><img src="../img/icon_del.png" width="19" height="20" border="0"></a></td>
            </tr>
        ...
        <? }?>    
          <blockquote>
           <!-- <strong>
            ...
            <p><a href="javascript:cargar_noticias('agregar_get_cat.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>','tbnoticia')" class="fuente linksRojo"><strong>[+] Agregar Nuevo Articulo</strong></a></p>
