...
<?
    ...
    mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsCatCla = "SELECT * FROM categoria_clasificado WHERE Id_CategoriaClasificado=$id_cat_cat";
$rsCatCla = mysql_query($query_rsCatCla, $cnx_arica) or die(mysql_error());
$row_rsCatCla = mysql_fetch_assoc($rsCatCla);
$totalRows_rsCatCla = mysql_num_rows($rsCatCla); }?>

         <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../clasificados/index.php">M&oacute;dulo Categoria de Clasificado</a> / <a id="guia_titulos" href="../articulos_clasificados/index_get_cat.php?id_cat_cat=<?php echo $row_rsTipo['Id_CategoriaClasificado'];?> ">Anuncios Clasificados por <?php echo $row_rsTipo['Nombre_CatCla'];?></a></p></strong>
      <p class="titles">&raquo; Anuncios Clasificados por <?php echo $row_rsTipo['Nombre_CatCla'];?> / Editar</p>
      ...
      <tr>
        <td valign="middle"><blockquote>
          ...
          <p><a href="index_get_cat.php?id_cat_cat=<? echo $row_rsTipo['Id_CategoriaClasificado'];?>" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Anuncios / Clasificados por <?php echo $row_rsTipo['Nombre_CatCla'];?></strong></a></p>
