...
$id_del=$_POST['id_del'];
	...
	$query_rsProducto = "SELECT * FROM empresa, empresa_rubro WHERE empresa_rubro.Id_Rubro= $id_del AND empresa.Id_Rubro_Empresa  = empresa_rubro.Id_Rubro";
...
$deleteSQL = "DELETE FROM empresa_rubro WHERE Id_Rubro =$id_del";
	mysql_select_db($database_cnx_arica, $cnx_arica);
