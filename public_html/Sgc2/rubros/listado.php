...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsCategoria = "SELECT * FROM empresa_rubro ORDER by Orden_Rubro asc";
...
?>
  <tr>
    ...
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../rubros/index.php">M&oacute;dulo Rubro de Empresa</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo Rubro de Empresa</p>
 ...
 <td width="15%" bgcolor="#003366" class="blanco12"><strong class="blanco11">Estado</strong></td>
          ...
          <?php do { ?>
            <tr class="odd">
               ...
               <? /* <a href="categoria.php?id_cat=<?php echo $row_rsCategoria['Id_CategoriaClasificado']; ?>" class="fuente"><strong><?php echo $row_rsCategoria['Nombre_Rubro']; ?></strong></a><? */?>
                
                <strong><a id="subrayado_cat_not" href="../empresas/index_get_rubro.php?id_rub_rub=<? echo $row_rsCategoria['Id_Rubro']; ?>"><?php echo utf8_encode($row_rsCategoria['Nombre_Rubro']); ?></a></strong>
                </td>
                <td class="fuente"   align="left"> <strong><? echo  $row_rsCategoria['Orden_Rubro'];?></strong>
             
     <? if($row_rsCategoria['Orden_Rubro']< $totalRows_rsCategoria){?>
<a href="#" onclick ="javascript:MM_goToURL('parent','bajar.php?id_cat=<?php echo $row_rsCategoria['Id_Rubro'];?>&orden=<?php echo $row_rsCategoria['Orden_Rubro']; ?>')">
<img src="../img/down_icon.png"  onmouseover="this.src='../img/down_icon_hover.png'" onmouseout="this.src='../img/down_icon.png'" alt="Down to <?php echo $row_rsCategoria['Orden_Rubro']+1;?>"  width="19" height="17" border="0"></a> 
      <? } ?>        
  <? if ($row_rsCategoria['Orden_Rubro']>1){?>                 
<a href="javascript:MM_goToURL('parent','subir.php?id_cat=<?php echo $row_rsCategoria['Id_Rubro']; ?>&orden=<?php echo $row_rsCategoria['Orden_Rubro'];?>')">
<img src="../img/up_icon.png"  onmouseover="this.src='../img/up_icon_hover.png'" onmouseout="this.src='../img/up_icon.png'" alt="A <?php echo $row_rsCategoria['Orden_Rubro']-1; ?>" width="19" height="17" border="0"></a>
          </td> <? } ?>
                  <td align="center"><select name="estado<?php echo $row_rsCategoria['Id_Rubro']; ?>" class="fuente" id="estado<?php echo $row_rsCategoria['Id_Rubro']; ?>" onChange="cargar('estado.php?id_cat=<?php echo $row_rsCategoria['Id_Rubro']; ?>&estado='+this.value,'estado<?php echo $row_rsCategoria['Id_Rubro']; ?>')">
                  <option value="1" <?php if (!(strcmp(1, $row_rsCategoria['Estado_Rubro']))) {echo "selected=\"selected\"";} ?>>Habilitado</option>
                  <option value="0" <?php if (!(strcmp(0, $row_rsCategoria['Estado_Rubro']))) {echo "selected=\"selected\"";} ?>>Deshabilitado</option>
                </select></td>
              <td align="center"><a href="javascript:cargar('editar.php?id_cat=<?php echo $row_rsCategoria['Id_Rubro']; ?>','tabla')"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
              <td align="center"><a href="javascript:preguntar('<?php echo $row_rsCategoria['Id_Rubro']; ?>','<?php echo utf8_encode($row_rsCategoria['Nombre_Rubro']); ?>','<?php echo $row_rsCategoria['Orden_Rubro']; ?>')"><img src="../img/icon_del.png" width="19" height="20" border="0"></a></td>
            </tr>
...
Rubros del <?php echo ($startRow_rsCategoria + 1) ?> al <?php echo min($startRow_rsCategoria + $maxRows_rsCategoria, $totalRows_rsCategoria) ?> de <?php echo $totalRows_rsCategoria ?> en total</td>
            ...
            <p><a href="javascript:cargar('agregar.php?orden=<? echo $totalRows_rsCategoria +1 ?>','tabla')" class="fuente linksRojo"><strong>[+] Agregar Nuevo Rubro</strong></a></p><? } ?>
