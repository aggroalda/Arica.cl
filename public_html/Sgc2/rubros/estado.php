...
if ((isset($_GET['id_cat'])) && ($_GET['id_cat'] != "")) {
  ...
  $updateSQL = "UPDATE empresa_rubro SET Estado_Rubro = $esta WHERE Id_Rubro = ".$_GET['id_cat'];
  ...
  $id_cat= $_GET['id_cat'];
  $updateSQL2 = "UPDATE empresa,empresa_rubro SET Estado_Emp= $esta WHERE empresa.Id_Rubro_Empresa= $id_cat
                 AND empresa.Id_Rubro_Empresa= empresa_rubro.Id_Rubro";
  mysql_select_db($database_cnx_arica, $cnx_arica);
...
<?
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsCategoria = "SELECT * FROM empresa_rubro where Id_Rubro= $id_cat";
