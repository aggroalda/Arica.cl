...
if (!((isset($_SESSION['MM_arica'])) && (isAuthorized("2,4,5",$MM_authorizedUsers, $_SESSION['MM_arica'], $_SESSION['MM_UserGroup'])))) {   
  $MM_qsChar = "?";
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Mensaje - Listado</p>
          ...
          <table width="98%" align="center" class="bordes2" >
            ...
            <tbody class="tabla">          
                <tr class="odd" style="display:none">
                  <td class="fuente"><strong>- <a href="ver_basicos.php" class="fuente">Direcci&oacute;n, Tel&eacute;fono y Correo de Contacto</a></strong></td>
                  <td align="center"><a href="basicos.php"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
                </tr>
                
                <tr class="odd">
                  <td class="fuente"><p><strong>- <? echo utf8_encode($row_rsMensaje['tituloMensaje']); ?></strong></p></td>
