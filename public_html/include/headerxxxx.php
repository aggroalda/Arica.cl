...
<title><? if($row_rsImagen2){echo utf8_encode($row_rsImagen2['Titulo_Not']);} else {?> arica.cl | El verdadero portal de Arica<? } ?></title>
<meta name="description" content="<? echo utf8_encode(substr($row_rsImagen2['Desarrollo_Not'],0,300));?>">
