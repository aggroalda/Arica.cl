<?php //require_once('../funcionesFecha/funciones.php'); ?>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO personas (Nombres_Per, Paterno_Per, Materno_Per, FechaNac_Per, Sexo_Per, IdDocumento_Per, NumeroDoc_Per, Ciudad_Per, Direccion_Per, Telefono_Per) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nombres_Txt'], "text"),
                       GetSQLValueString($_POST['paterno_Txt'], "text"),
                       GetSQLValueString($_POST['materno_Txt'], "text"),
                       GetSQLValueString($_POST['fecnacimiento_text'], "date"),
 ...
 // $codigo = md5($codigo);
  ...
  $insert = "INSERT INTO usuarios (IdNivel_Usu, IdPersona_Usu, Usern_Usu, Passw_Usu) VALUES ('".$nivel."', '$id_persona', '".$_POST['usuario2_Txt']."', '$codigo')";
...
/*mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsPais = "SELECT * FROM pais ORDER BY Id_Pais ASC";
$rsPais = mysql_query($query_rsPais, $cnx_arica) or die(mysql_error());
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
        ...
        <td valign="middle"><blockquote>
          <table width="700px" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="895" background="../img/cdo_top_fnd.jpg">Formulario De Registro</td>
            ...
            <tr>
              ...
              <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1" >
                <table width="100%">
                  ...
                  <tr>
                    <td width="43%" align="right" class="fuente"><strong>Usuario / Correo Electr&oacute;nico:</strong></td>
                    <td width="57%" class="fuente"><input name="usuario_Txt2" type="text" class="fuente" id="usuario_Txt2" size="35" style="float:left;" onBlur="verifyuser(0)"><div id="dvResultado"></div></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="fuente"><input name="materno_Txt" type="text" class="fuente" id="materno_Txt"></td>
                    
                  </tr>
                  
                   <tr>
                    <td align="right" class="fuente"><strong>Fecha de Nacimiento:</strong></td>
                    <td align="left" class="fuente"><input name="fecnacimiento_text" type="text" class="fuente" id="fecha_Txt"  onfocus="showCalendarControl(this);"></td>
                    
                  </tr>
                  
                   <tr>
                    <td align="right" class="fuente"><strong>Sexo</strong></td>
                    <td align="left" class="fuente"><select name="sexo_text" class="fuente" id="sexo_text">
                  ...
                  <tr>
                    ...
                    <td align="left" class="fuente">
                      <select name="tipodoc_Txt" class="fuente" id="tipodoc_Txt">
                        <option value="">-- Seleccione --</option>
                        <?php do {  ?>
                        <option value="<?php echo $row_rsDocumento['Id_Documentos']?>"><?php echo $row_rsDocumento['Descripcion_Doc']?></option>
