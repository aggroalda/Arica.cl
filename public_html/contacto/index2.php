...
<div >
	...
	<div id="titulo_registro"> 
	 Información de Contacto
      <p>Teléfono: <? echo $row_rsOpcion['telefono_opc']; ?>
<?

?><br>
        Dirección: <? echo $row_rsOpcion['direccion_opc']; ?> <br>
        Sitio Web: <strong><a href="http://www.fulldent.cl">http://www.arica.cl</a></strong><a href="http://www.fulldent.cl"><br>
  </a>Correo electrónico:<strong> <a href="mailto:<? echo $row_rsOpcion['email_contacto_opc'];?>"><? echo $row_rsOpcion['email_contacto_opc'];?></a></strong><br>
