...
<div id="twitter_compartir"><g:plus action="share" annotation="vertical-bubble"></g:plus></div>
  ...
  <?php /*?>  <div id="fb-root"></div>
    ...
    <div id="twitter_compartir" class="fb-like" data-send="true" data-layout="box_count" data-width="auto" data-show-faces="true" data-font="verdana"></div><?php */?>
   
   <div id="iframe_megusta_detalle"> 
        <iframe src="http://www.facebook.com/plugins/like.php?href=http://www.arica.cl<? echo $_SERVER['PHP_SELF'].$_SERVER['QUERY_STRING']; ?>"
