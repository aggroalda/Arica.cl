...
$palabra=$row_rsImagen2['Descripcion_Gal'];
 ...
 ?>
				...
				<h3><a id="noticias-titulo" class="alink" href="../novedades/detalle.php?id_not=<? echo $row_rsImagen2['Id_Noticia']?>"> 
 ...
 <? if ($totalPages_rsNoticias>0){?>
    <div style="width:700px;height:50px;float:left">
       ...
       <? if (($numerodepagina-1) >=0){?>
        <a style="color:#FF6600" href="javascript:cargar('../novedades/noticiaspaginacion.php?<? if ($id_tip){?>id_tip=<?=$id_tip?><? } ?>&numerodepagina=<? echo ($numerodepagina - 1);?>','featured2')">
      Anterior</a> <? }?>
                <? for ($i=0; $i<=$totalPages_rsNoticias;$i++){?>
                
    <a  style="color:#FF6600" href="javascript:cargar('../novedades/noticiaspaginacion.php?<? if ($id_tip){?>id_tip=<?=$id_tip?><? } ?>&numerodepagina=<? echo $i;?>','featured2')" >
			   <? echo $i+1?>
                </a>
              
                <? }?>
               
          <? if (($numerodepagina+1)<=$totalPages_rsNoticias){?>   <a style="color:#FF6600" href="javascript:cargar('../novedades/noticiaspaginacion.php?<? if ($id_tip){?>id_tip=<?=$id_tip?><? } ?>&numerodepagina=<? echo ($numerodepagina + 1);?>','featured2')">Siguiente</a><? }?>
