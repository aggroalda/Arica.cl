...
?>	
    ...
    <a href="#"><!--Empresas &raquo;--></a>
		...
		<li><a href="../empresas/detalle.php?id_emp=<? echo $row_rsNoticias{'Id_Empresa'}; ?>&id_rub=<? echo $row_rsNoticias{'Id_Rubro'}; ?>&id_usu=<? echo $_SESSION['MM_IdUser']; ?>"><? echo utf8_encode($row_rsNoticias['Nombre_Emp']); ?></a></li>
