...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE categoria_clasificado SET Nombre_CatCla=%s, Estado_CatCla=%s WHERE Id_CategoriaClasificado=%s",
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Categoria de Clasificado - Editar</p>
      ...
      <tr>
        <td valign="middle"><blockquote>
                ...
                <table width="100%">
                  <tr>
                    ...
                    <td><label for="categoria_Txt2"></label>
                      ...
                      <input name="nombre_Txt" type="text" class="fuente" id="nombre_Txt" title="Nombre de Categor�a "value="<?php echo utf8_encode($row_rsCategoria['Nombre_CatCla']); ?>"></td>
                  </tr>
                  <tr>
                    <td width="46%" align="right" class="fuente"><strong>Estado:</strong></td>
                    <td width="54%" class="fuente"><label for="categoria_Txt"></label>
                      <label for="nombre_Txt"></label>
                      <input <?php if (!(strcmp($row_rsCategoria['Estado_CatCla'],1))) {echo "checked=\"checked\"";} ?> name="estado_Txt" type="checkbox" id="estado_Txt" value="1">
                      <label for="estado_Txt">Habilitado</label></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center">
                      <input type="hidden" name="MM_update" value="form1">
                      <input name="id_cat" type="hidden" id="id_cat" value="<?php echo $row_rsCategoria['Id_CategoriaClasificado']; ?>">
          ...
          <p><a href="javascript:cargar('listado.php','tabla')" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Categoria de Clasificado</strong></a></p>
