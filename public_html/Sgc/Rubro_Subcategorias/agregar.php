...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsOrden = "SELECT max(Rubro_Sub_Orden) FROM empresa_rubro_sub";
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo Subcategoría de Rubro de Empresa- Agregar</p>
        ...
        <td valign="middle"><blockquote>
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td bgcolor="#EBEBEB"><form method="POST" name="form1" target="frameSave"  id="form1">
                <table width="100%">
                  <tr>
                    <td width="46%" align="right" class="fuente"><strong>Subcategoría Rubro:</strong></td>
                    <td width="54%">
                     
                      <input type="text" name="nombre_Txt" id="nombre_Txt" title="Nombre de Categor&iacute;a" required="required">
                  ...
                  <tr>
                   ...
                   <option value="">Seleccione</option>
                    <? do {?>
                    <option value="<? echo $row_rsTipo['Id_Rubro']?>"><? echo utf8_encode($row_rsTipo['Nombre_Rubro']);?></option>
                  ...
                  <tr><td colspan="2" align="center">
                    <input name="SendForm" type="submit" id="SendForm" value=" Guardar " onclick="javascript:agregar_subcategoriarubro()">
                  </td></tr>
                </table>
              </form></td>
