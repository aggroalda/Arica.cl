...
$msg = "<!DOCTYPE html><html><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><title>arica.cl | El verdadero portal de Arica</title><head><body>
  ...
  header("Location:ver.php?id_pro=$id_pro&rubro=$rubro");
}
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../empresas/index.php">M&oacute;dulo de Empresa</a> / <a id="guia_titulos" href="#">Agregar</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo de Empresa / Agregar </p>
        ...
        <td valign="middle"><blockquote>
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>"  enctype="multipart/form-data" method="POST" name="form1" id="form1">
                <table width="100%">
                 
                
                  <tr>
                    <td align="right" class="fuente"><strong>Nombre de Empresa:</strong></td>
                    <td><input name="nombre_Txt" type="text" class="fuente" id="nombre_Txt" size="35" title="Nombre de Empresa" required="required"></td>
                  </tr>
                     <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="foto_Txt" type="file" class="fuente" id="foto_Txt" onChange="imagenval(this.id)" required="required">
                    </td>
                  </tr>
                  
                  <tr>
                    <td align="right" valign="top" class="fuente"><strong>Descripci&oacute;n:</strong></td>
                    <td><textarea name="descripcion_Txt" cols="45" rows="3" class="fuente" id="descripcion_Txt"  onkeyup="mostrarResultado(this.value,140,'spcontando');contarCaracteres(this.value,140,'sprestante');valida_longitud()" onKeyDown="valida_longitud()"  required="required"><? echo truncate($row_rsProductos['Descripcion_Emp'],140);?></textarea>
                    <br />
...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span></td>
        		   ...
        		   <tr>
                    ...
                    <td align="left"><select name="rubro" class="fuente" id="rubro"  title="Rubro" onChange="javascript:var id_rub=this.value; cargar('recargar_lista_sub.php?id_rub='+ id_rub,'recargar_lista')" required="required">
                   <option value="">-- Seleccione --</option>
                    <? do {?>
                    <option value="<? echo $row_rsTipo2['Id_Rubro']?>" ><? echo utf8_encode($row_rsTipo2['Nombre_Rubro'])?></option>
                   ...
                   <option value="">-- Seleccione --</option>
                    ...
                    <td><input name="ciudad_Txt" type="text" class="fuente" id="ciudad_Txt" size="25" title="Nombre de Producto" required="required" ></td>
                  </tr>
                   <tr>
                    <td align="right" class="fuente"><strong>Dirección:</strong></td>
                    <td><input name="direccion_Txt" type="text" class="fuente" id="direccion_Txt" size="40" title="Nombre de Producto" required="required"></td>
                  </tr>
                   <tr>
                    <td align="right" class="fuente"><strong>Teléfono:</strong></td>
                    <td><input name="telefono_Txt" type="text" class="fuente" id="telefono_Txt" size="20" title="Nombre de Producto" required="required"></td>
                  </tr>
                   <tr>
                    <td align="right" class="fuente"><strong>Correo:</strong></td>
                    <td><input name="correo_Txt" type="text" class="fuente" id="correo_Txt" size="25" title="Nombre de Producto" required="required"></td>
                  </tr>
                                     	<tr>
          ...
          <p><a href="index.php" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Empresas</strong></a></p>
