...
$query_rsProductos = "SELECT * FROM empresa  WHERE empresa.IdUsuario_Emp='$usuario' ORDER BY empresa.Id_Empresa ASC";
	...
	$id_rub_rub=$_GET['id_rub_rub'];
		$query_rsProductos2 = "SELECT * FROM empresa, empresa_rubro WHERE empresa.Id_Rubro_Empresa = empresa_rubro.Id_Rubro AND empresa_rubro.Id_Rubro=$id_rub_rub ORDER BY Id_Empresa ASC";
}	
elseif (!$_GET['id_tip']){
...
$totalRows_rsRubroE = mysql_num_rows($rsRubroE);
	...
	?>
     <strong>
     <p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../rubros/index.php">M&oacute;dulo Rubro de Empresa</a> / <a id="guia_titulos" href="../empresas/index_get_rubro.php?id_rub_rub=<? echo $_GET['id_rub_rub'];?>">Rubro de Empresa <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?></a> / <a  id="guia_titulos" href="#">Listado</a></p></strong>
      <p class="titles">&raquo;Rubro de Empresa <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?> / Listado</p>
...
<table width="100%" align="center" class="bordes2" >
       ...
       <td width="10%" bgcolor="#003366" class="blanco12"><strong class="blanco11">Estado</strong></td>
		  ...
		  ?>
            <tr class="odd">
                <td class="fuente">&nbsp;<a href="ver_get_rubro.php?id_pro=<?php echo $row_rsProductos['Id_Empresa']; ?>" class="fuente"><strong><?php echo utf8_encode($row_rsProductos['Nombre_Emp']); ?></strong></a>
<?php /*?><!--        <a id="abajo<?php echo $row_rsProductos['Id_Empresa']; ?>" href="javascript:cargar('destinos.php?id_emp=<?php echo $row_rsProductos['Id_Empresa']; ?>','dv<?php echo $row_rsProductos['Id_Empresa']; ?>')
            ...
            <td class="fuente">&nbsp;<a id="subrayado_cat_not" href="javascript:cargar('../empresas/index_get_rubro.php?id_rub_rub=<? echo $row_rsProductos['Id_Rubro']?>','tbnoticia')">
           <strong><?php echo utf8_encode($row_rsProductos['Nombre_Rubro']); ?></strong></a>
                ...
                <td align="center"><select name="estado<?php echo $row_rsProductos['Id_Empresa'];?>" class="fuente" id="estado<?php echo $row_rsProductos['Id_Empresa']; ?>" onChange="cargar('estado.php?id_pro=<?php echo $row_rsProductos['Id_Empresa']; ?>&estado='+this.value,'estado<?php echo $row_rsProductos['Id_Empresa']; ?>')">
                 ...
                 <td align="center"><a href="editar_get_rubro2.php?id_rub_rub=<? echo $_GET['id_rub_rub'];?>&id_pro=<?php echo $row_rsProductos['Id_Empresa']; ?>&rubro_sub=<? echo $row_rsProductos['Rubro_Sub_Id'];?>"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
...
<!--<p><a href="../empresas/index.php" class="fuente linksRojo"><strong>Módulo de Empresa Lista Original</strong></a></p>-->
            <p><a href="agregar_get_rubro2.php?id_rub_rub=<? echo $_GET['id_rub_rub']; ?>" class="fuente linksRojo"><strong>[+] Agregar  Empresa</strong></a></p>
            <?  if ($_POST['codigo_Txt']) { ?>
