...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsTipo = "SELECT * FROM empresa_rubro_sub where Rubro_Id = ".$_GET['id_rub_rub'];
...
$totalRows_rsRubroE = mysql_num_rows($rsRubroE);
	?>
        <strong>
         <p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../rubros/index.php">M&oacute;dulo Rubro de Empresa</a> / <a id="guia_titulos" href="../empresas/index_get_rubro.php?id_rub_rub=<?php echo $_GET['id_rub_rub']; ?>">Rubro de Empresa <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?></a> / <a id="guia_titulos" href="#">Agregar</a></p></strong>
      <p class="titles">&raquo; Rubro de Empresa <?php echo utf8_encode($row_rsRubroE['Nombre_Rubro']); ?> / Agregar </p>
...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span></td>
        		   ...
        		   <tr>
                    ...
                    <td align="left"><select name="rubro" class="fuente" id="rubro"  title="Nombre de Rubro" required="required">
