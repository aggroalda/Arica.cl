      ...
      <tr>
       ...
       <? if(($row_rsProducto['Direccion_Emp'])!=NULL){ ?>
         ...
         <? }?>
          ...
          <tr>
            <td height="11" colspan="2" align="left" bgcolor="#EBEBEB"><a href="../empresas/editar.php?id_pro=<?php echo $row_rsProducto['Id_Empresa'];?>&rubro_sub=<? echo$row_rsProducto['Rubro_Sub_Id'];?>" class="fuente linksRojo"><strong>EDITAR ESTE EMPRESA</strong></a></td>
            </tr>
