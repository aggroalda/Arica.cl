...
<span id="sprestante" style="font-family:Verdana, Geneva, sans-serif; font-size:12px;"></span></td>
        		   ...
        		   <tr>
                    ...
                    <td align="left"><select name="rubro" class="fuente" id="rubro"  title="Rubro" onChange="javascript: cargar('recargar_lista_sub.php?id_rub='+ this.value,'recargar_lista')" required="required">
