...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
        <strong>
        <p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../rubros/index.php">M&oacute;dulo Rubro de Empresa</a> / <a id="guia_titulos"
 href="../empresas/index_get_rubro.php?id_rub_rub=<?php echo $row_rsProducto['Id_Rubro'];?>">Rubro de Empresa <?php echo utf8_encode($row_rsProducto['Nombre_Rubro']); ?></a> / <a id="guia_titulos" href="../empresas/ver_get_rubro.php?id_pro=<? echo $_GET['id_pro']; ?>">Detalles</a></p></strong>
      <p class="titles">&raquo;Rubro de Empresa  <?php echo utf8_encode($row_rsProducto['Nombre_Rubro']); ?> / Detalles</p>
      ...
      <? if(($row_rsProducto['Direccion_Emp'])!=NULL){ ?>
         ...
         <? }?>
          ...
          <tr>
            <td height="11" colspan="2" align="left" bgcolor="#EBEBEB"><a href="../empresas/editar_get_rubro.php?id_rub_rub=<?php echo $row_rsProducto['Id_Rubro']; ?>&id_pro=<?php echo $row_rsProducto['Id_Empresa']; ?>&rubro_sub=<? echo $row_rsProducto['Rubro_Sub_Id'];?>" class="fuente linksRojo"><strong>EDITAR ESTA EMPRESA</strong></a></td>
            </tr>
          ...
          <blockquote>
          <p><a href="../empresas/agregar_get_rubro.php?id_pro=<? echo $_GET['id_pro'];?>&id_rub_rub=<?php echo $row_rsProducto['Id_Rubro'];?>" class="fuente linksRojo"><strong>[+] Agregar Nueva Empresa</strong></a></p>
         
            <p><a href="../empresas/index_get_rubro.php?&id_rub_rub=<?php echo utf8_encode($row_rsProducto['Id_Rubro']); ?>" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Empresas / Rubro de Empresa <?php echo utf8_encode($row_rsProducto['Nombre_Rubro']); ?></strong></a></p>
