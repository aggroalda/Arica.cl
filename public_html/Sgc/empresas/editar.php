...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsRubroSub = "SELECT * FROM empresa_rubro_sub,empresa_rubro, empresa WHERE empresa_rubro_sub.Rubro_Id = empresa_rubro.Id_Rubro AND empresa_rubro.Id_Rubro = empresa.Id_Rubro_Empresa AND empresa.Id_empresa=".$colname_rsProductos;
