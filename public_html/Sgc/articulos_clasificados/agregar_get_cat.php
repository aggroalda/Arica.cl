...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsTipo2 = "SELECT * FROM categoria_clasificado WHERE Id_CategoriaClasificado=$id_cat_cat ORDER BY Nombre_CatCla ASC";
...
?>
  ...
  <tr>
    <td><blockquote>
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../clasificados/index.php">M&oacute;dulo Categoria de Clasificado</a> / <a id="guia_titulos" href="../articulos_clasificados/index_get_cat.php?id_cat_cat=<? echo $_GET['id_cat_cat'];?>">Anuncios Clasificados por <? echo utf8_encode($row_rsTipo2['Nombre_CatCla']);?></a></p></strong>
      <p class="titles">&raquo; Anuncios Clasificados por <? echo utf8_encode($row_rsTipo2['Nombre_CatCla']);?> / Agregar</p>
...
<td><input name="correo_Txt" type="text" class="fuente" id="correo_Txt" size="40" title="Telefono">
          ...
          <p><a href="javascript:cargar('noticiapagina_get_cat.php?id_cat_cat=<? echo $_GET['id_cat_cat'];?>','tbnoticia')" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Anuncios / Clasificados por <? echo utf8_encode($row_rsTipo2['Nombre_CatCla']);?></strong></a></p>
