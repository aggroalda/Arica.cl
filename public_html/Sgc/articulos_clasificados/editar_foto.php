...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE galeria SET Descripcion_Gal=%s WHERE Id_Galeria=%s",
                       ...
                       GetSQLValueString($_POST['descripcion_gal'], "text"),
                       GetSQLValueString($_POST['id_gal'], "int"));
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Productos - Editar Fotos</p>
        ...
        <td valign="middle">
          <table width="77%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="749" background="../img/cdo_top_fnd.jpg"></td>
              ...
              <td bgcolor="#EBEBEB"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><label>
                      <textarea name="descripcion_gal" cols="45" rows="5" class="fuente" id="descripcion_gal" title="Descripci�n"><?php echo $row_rsGaleria['Descripcion_Gal']; ?></textarea>
                    </label></td>
                  </tr>
                  <tr>
