...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Mensaje - Actualizar Mensaje</p>
          ...
          <tr><td background="../img/cdo_izq_fnd.jpg"></td>
            <td bgcolor="#EBEBEB"><form  method="GET" name="form1" id="form1">
              <table width="100%">
                ...
                <tr>
                  <td align="right" class="fuente"><strong>Nuevo T&iacute;tulo del mensaje:</strong></td>
                  <td><input name="titulo_Txt" type="text" class="fuente" id="titulo_Txt" value="<? echo utf8_encode($row_rsMensaje['tituloMensaje']); ?>" ></td>
                </tr>
                
                   <tr>
                  <td align="right" class="fuente"><strong>Nueva descripci&oacute;n del mensaje:</strong></td>
 <td><textarea name="descrip_Txt" type="text" class="fuente" id="descrip_Txt" 
 value="<? echo utf8_encode($row_rsMensaje['DescripMensaje']);?>"></textarea></td>
                </tr>
              
                  <td colspan="2" align="center">
                    <input name="btnGuardar" type="button" id="btnGuardar" onClick="cambiarMensaje();" value=" Cambiar "></td>
                </tr>
              </table>
            </form></td>
          ...
          <blockquote>
          <p><a href="index.php" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Mensaje</strong></a></p>
