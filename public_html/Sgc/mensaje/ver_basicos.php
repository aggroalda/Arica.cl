            ...
            <td bgcolor="#EBEBEB"><form method="POST" enctype="multipart/form-data" name="form1">
              <table width="100%">
                <tr>
                  ...
                  <td width="55%" class="fuente"><?php echo $row_rsBasicos['Nombres_Per']; ?></td>
                </tr>
                <tr>
                  <td width="45%" align="right" class="fuente"><strong>Apellido Paterno:</strong></td>
                  <td width="55%" class="fuente"><?php echo $row_rsBasicos['Paterno_Per']; ?></td>
                </tr>
                <tr>
                  <td width="45%" align="right" class="fuente"><strong>Apellido Materno:</strong></td>
                  <td width="55%" class="fuente"><?php echo $row_rsBasicos['Materno_Per']; ?></td>
                </tr>
                 <tr>
                  <td align="right" class="fuente"><strong>Pais:</strong></td>
                  <td class="fuente"><?php echo $row_rsBasicos['Nombre_Pai']; ?></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Numero de Documento:</strong></td>
                  <td class="fuente"><?php echo $row_rsBasicos['NumeroDoc_Per']; ?></td>
                </tr>
                 <tr>
                  <td align="right" class="fuente"><strong>Ciudad:</strong></td>
                  <td class="fuente"><?php echo $row_rsBasicos['Ciudad_Per']; ?></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Tel&eacute;fono:</strong></td>
                  <td class="fuente"><?php echo $row_rsBasicos['Direccion_Per']; ?></td>
                </tr>
              <tr>
                  <td align="right" class="fuente"><strong>Correo:</strong></td>
                  <td class="fuente"><?php echo $row_rsBasicos['Usern_Usu']; ?></td>
                </tr>
