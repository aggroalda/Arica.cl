...
function agregar_subcategoriarubro() {
	
	if (document.getElementById('nombre_Txt').value!=""){
	 nombre=document.getElementById('nombre_Txt').value;
	 tipo=document.getElementById('tipo_Txt').value;
	 orden=document.getElementById('orden').value;
	ajax=objetoAjax();
		
	ajax.open("GET","agregar_proceso.php?nombre="+nombre+"&orden="+orden+"&tipo="+tipo,true);
...
function eliminar_sub_categoria_rub(id,name,orden) {
confirmar=confirm("¿Está seguro de eliminar esta subcategoría de rubro "+ name +"?. Eliminará las empresas relacionadas ."); 
if (confirmar) {//Aquí pones lo que quieras si da a Aceptar 
