...
?>
  <tr>
    <td>
    <blockquote>
    	<strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../categorias/index.php">M&oacute;dulo de Categor&iacute;a de Noticia</a> / <a id="guia_titulos" href="#">Listado</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo de Categor&iacute;a de Noticia</p>
...
<img src="../img/up_icon.png"  onmouseover="this.src='../img/up_icon_hover.png'" onmouseout="this.src='../img/up_icon.png'" alt="A <?php echo $row_rsCategoria['Orden_Cat']-1; ?>" width="19" height="17" border="0">
              ...
              <td align="center"><a href="javascript:cargar_agregar_categoria('editar.php?id_cat=<?php echo $row_rsCategoria['Id_Categoria']; ?>','tabla')"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
              <td align="center"><a href="javascript:preguntar('<?php echo $row_rsCategoria['Id_Categoria']; ?>','<?php echo utf8_encode($row_rsCategoria['Nombre_Cat']); ?>','<? echo $row_rsCategoria['Orden_Cat'];?>')"><img src="../img/icon_del.png" width="19" height="20" border="0"></a></td>
            </tr>
...
Categor&iacute;as del <?php echo ($startRow_rsCategoria + 1) ?> al <?php echo min($startRow_rsCategoria + $maxRows_rsCategoria, $totalRows_rsCategoria) ?> de <?php echo $totalRows_rsCategoria ?> en total</td>
            ...
            <p><a href="javascript:cargar_agregar_categoria('agregar.php?orden=<? echo $totalRows_rsCategoria +1 ?>','tabla')" class="fuente linksRojo"><strong>[+] Agregar Nueva Categoría de Noticia</strong></a></p>
