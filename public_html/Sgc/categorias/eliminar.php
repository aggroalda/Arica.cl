    ...
    <td><blockquote>
      ...
      <tr>
        <td valign="middle"><blockquote>
                ...
                <table width="100%">
                  <tr>
                    ...
                    <td width="54%" class="fuente">
                      <?php echo utf8_encode($row_rsCategoria['Nombre_Cat']); ?></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center" class="linksRojo fuente"><strong>&iquest;Est&aacute; seguro de eliminar esta categor&iacute;a de noticia? Eliminar&aacute; las noticias relacionadas a esta categor&iacute;a.</strong></td>
                  </tr>
                  <tr>
                    ...
                    <input type="hidden" value="<? echo $_GET['id_del']?>" id="id_del" name="id_del">
                      ...
                      <input name="SendForm" type="submit" id="SendForm" value=" Eliminar " onClick="javascript:return eliminar_categoria('<?php echo $row_rsCategoria['Id_Categoria']; ?>','<?php echo utf8_encode($row_rsCategoria['Nombre_Cat']); ?>','<?php echo $row_rsCategoria['Orden_Cat']; ?>')">
                      </form>
          ...
          <p><a href="javascript:cargar('listado.php','tabla')" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Categor&iacute;a de Noticia</strong></a></p>
