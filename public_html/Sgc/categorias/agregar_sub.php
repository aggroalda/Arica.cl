...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO subcategoria (IdCategoria_Sub, Nombre_Sub) VALUES (%s, %s)",
  ...
  $insertGoTo = "categorias.php?id_cat=".$_POST['id_cat'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Categorias - Agregar Subcategor&iacute;a</p>
      ...
      <tr>
        <td valign="middle"><blockquote>
              ...
              <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
                <table width="100%">
                  <tr>
                    ...
                    <td width="54%">
                      <input type="text" name="nombre_Txt" id="nombre_Txt" title="Nombre de Subcategoria"></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center">
                      <input name="id_cat" type="hidden" id="id_cat" value="<?=$_GET['id_cat']?>">
          ...
          <p><a href="categorias.php?id_cat=<?=$_GET['id_cat']?>" class="fuente linksRojo"><strong>&laquo; Volver al Listado de SubCategorias</strong></a></p>
