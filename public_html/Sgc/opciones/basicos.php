...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE opciones SET direccion_opc=%s,direccion2_opc=%s, celular_opc=%s, telefono_opc=%s, telefono2_opc=%s,email_opc=%s,email_contacto_opc=%s",
					   ...
					   GetSQLValueString($_POST['email_adm_Txt'], "text"),
					   GetSQLValueString($_POST['email_contacto_Txt'], "text")
					   );
            ...
            <td bgcolor="#EBEBEB"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
              <table width="100%">
                <tr>
                  ...
                  <td width="55%"><input name="direccion_Txt" type="text" class="fuente" id="direccion_Txt" title="Dirección" value="<?php echo $row_rsBasicos['direccion_opc']; ?>" size="40"></td>
                </tr>
                <tr>
                  <td width="45%" align="right" class="fuente"><strong>Direcci&oacute;n 2 :</strong></td>
                  <td width="55%"><input name="direccion2_Txt" type="text" class="fuente" id="direccion2_Txt" title="Dirección2" value="<?php echo $row_rsBasicos['direccion2_opc']; ?>" size="40"></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Celular:</strong></td>
                  <td><input name="celular_Txt" type="text" class="fuente" id="celular_Txt" title="Celular" value="<?php echo $row_rsBasicos['celular_opc']; ?>"></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Tel&eacute;fono:</strong></td>
                  <td><input name="telefono_Txt" type="text" class="fuente" id="telefono_Txt" title="Teléfono" value="<?php echo $row_rsBasicos['telefono_opc']; ?>"></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Tel&eacute;fono 2:</strong></td>
                  <td><input name="telefono2_Txt" type="text" class="fuente" id="telefono2_Txt" title="Teléfono2" value="<?php echo $row_rsBasicos['telefono2_opc']; ?>"></td>
                </tr>
                   <tr>
                  <td align="right" class="fuente"><strong>Email de Administrador:</strong></td>
                  <td><input name="email_adm_Txt" type="text" class="fuente" id="email_adm_Txt" title="email_adm_Txt" value="<?php echo $row_rsBasicos['email_opc']; ?>"></td>
                </tr>
                <tr>
                  <td align="right" class="fuente"><strong>Email de Contacto:</strong></td>
                  <td><input name="email_contacto_Txt" type="text" class="fuente" id="email_contacto_Txt" title="Email de Contacto" value="<?php echo $row_rsBasicos['email_contacto_opc']; ?>"></td>
                </tr>
                <tr>
                  <td colspan="2" align="center"><input type="hidden" name="MM_update" value="form1">
                    <input type="hidden" name="MM_insert" value="form1">
                    <input name="SendForm" type="submit" id="SendForm" onClick="MM_validateForm('direccion_Txt','','R','celular_Txt','','R','telefono_Txt','','R','email_adm_Txt','','RisEmail','email_contacto_Txt','','RisEmail');return document.MM_returnValue" value=" Guardar "></td>
                </tr>
              </table>
            </form></td>
