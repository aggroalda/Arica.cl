...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE empresa_rubro SET Nombre_Rubro=%s  WHERE Id_Rubro=%s",
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
      <p class="titles">&raquo; M&oacute;dulo de Rubro de Empresa- Editar</p>
                ...
                <table width="100%">
                  <tr>
                    ...
                    <td><label for="categoria_Txt2"></label>
                      ...
                      <input name="nombre_Txt" type="text" class="fuente" id="nombre_Txt" title="Nombre de Categor�a "value="<?php echo utf8_encode($row_rsCategoria['Nombre_Rubro']); ?>"></td>
                  </tr>
                
                  <tr>
                    <td colspan="2" align="center">
                      <input type="hidden" name="MM_update" value="form1">
                      <input name="id_cat" type="hidden" id="id_cat" value="<?php echo $row_rsCategoria['Id_Rubro']; ?>">
