...
mysql_select_db($database_cnx_arica, $cnx_arica);
$query_rsCategoria = sprintf("SELECT * FROM empresa_rubro WHERE Id_Rubro = %s", GetSQLValueString($colname_rsCategoria, "int"));
            ...
            <tr>
              ...
              <td bgcolor="#EBEBEB">
                <table width="100%">
                  ...
                  <tr>
                    <td colspan="2" align="center" class="linksRojo fuente"><strong>&iquest;Est&aacute; seguro de eliminar este Rubro? Eliminar&aacute; las empresas relacionadas a este rubro.</strong></td>
                  </tr>
                  <tr>
                    ...
                    <input type="hidden" value="<? echo $_GET['id_del']?>" id="id_del" name="id_del">
                      ...
                      <input name="SendForm" type="submit" id="SendForm" value=" Eliminar " onClick="javascript:return eliminar_categoria('<?php echo $row_rsCategoria['Id_Rubro']; ?>','<?php echo utf8_encode($row_rsCategoria['Nombre_Rubro']); ?>','<?php echo $row_rsCategoria['Orden_Rubro']; ?>')">
                      </form>
