...
if ($totalRows_rsPortada<1 && $i==1){$portada=1;} else{$portada=0;}
  ...
  mysql_query($insertSQL, $cnx_arica) or die(mysql_error());
		...
		header("Location: ver.php?id_not=$idnot");
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    <td><blockquote>
     <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../novedades/index.php">M&oacute;dulo de Noticia</a> / <a id="guia_titulos" href="../novedades/ver.php?id_not=<? echo $_GET['id_not']; ?>">Detalles</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo de Noticia / Agregar Fotos</p>
      ...
      <tr>
        <td valign="middle"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <blockquote>
            <p><a href="ver.php?id_not=<? echo $_GET['id_not'];?>" class="fuente linksRojo">&laquo; <strong>Volver al Detalle de 
              Noticia
              </strong></a></p>
