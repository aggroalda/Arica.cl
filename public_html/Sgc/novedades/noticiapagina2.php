...
?>
  ...
  <tr>
    <td><blockquote>
    	<strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../novedades/index.php">M&oacute;dulo de Noticia</a> / <a id="guia_titulos" href="#">Listado</a></p></strong>
      <p class="titles">&raquo; M&oacute;dulo de Noticia / Listado</p>
...
<strong>
<a class="fuente" href="ver.php?id_not=<?=$row_rsNoticias['Id_Noticia']?>"><?php echo utf8_encode($row_rsNoticias['Titulo_Not']); ?></a></strong></td>
                 <td align="center" class="fuente" ><a id="subrayado_cat_not" href="javascript:cargar('../novedades/noticiapagina.php?id_tip=<? echo $row_rsNoticias['Id_Categoria'] ?>','tbnoticia')"><? echo utf8_encode($row_rsNoticias['Nombre_Cat']);?></a></td>
         ...
         <?	}
              ...
              <td align="center"><a href="editar.php?id_not=<?php echo $row_rsNoticias['Id_Noticia']; ?>"><img src="../img/icon_edit.png" width="20" height="20" border="0"></a></td>
              <td align="center"><a href="javascript:preguntarNoticias('<?php echo $row_rsNoticias['Id_Noticia']; ?>','<?php echo utf8_encode($row_rsNoticias['Titulo_Not']); ?>')"><img src="../img/icon_del.png" width="19" height="20" border="0"></a></td>
            </tr>
              ...
              <table border="0">
                  ...
                  <tr>
                    <td align="center"><?php if ($numerodepagina > 0) { // Show if not first page ?>
                      ...
                      <a href="javascript:cargar('noticiapagina.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>&id_tip=<? echo $_GET['id_tip']; ?>&numerodepagina=0','tbnoticia')">
                      <img src="../img/First.gif" border="0"></a>
                      <?php } // Show if not first page ?></td>
                      
                      
                    <td align="center"><?php if ($numerodepagina > 0) { // Show if not first page ?>
                      <a href="javascript:cargar('noticiapagina.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>&id_tip=<? echo $_GET['id_tip']; ?>&numerodepagina=<? echo ($numerodepagina - 1);?>','tbnoticia')"><img src="../img/Previous.gif" border="0" /></a>
                      <?php } // Show if not first page ?></td>
                   
                    <td align="center"><?php if ($numerodepagina < $totalPages_rsNoticias) { // Show if not last page ?>
                     <a href="javascript:cargar('noticiapagina.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>&id_tip=<? echo $_GET['id_tip']; ?>&numerodepagina=<? echo ($numerodepagina + 1);?>','tbnoticia')">
                      <img src="../img/Next.gif" border="0"></a>
                      <?php } // Show if not last page ?></td>
                      
                      
                    <td align="center"><?php if ($numerodepagina < $totalPages_rsNoticias) { // Show if not last page ?>
                    <a href="javascript:cargar('noticiapagina.php?id_cat_cat=<? echo $_GET['id_cat_cat']; ?>&id_tip=<? echo $_GET['id_tip']; ?>&numerodepagina=<? echo $totalPages_rsNoticias;?>','tbnoticia')">
     ...
     <div class="fuente">No hay Noticias Agregadas
        ...
        <? }?>    
          <blockquote>
          <strong><p><a id="guia_titulos" href="../novedades/index.php">M&oacute;dulo de Noticia Lista Original</a></p></strong>
            <p><a href="javascript:cargar_noticias('agregar2.php','tbnoticia')" class="fuente linksRojo"><strong>[+] Agregar Nueva Noticia</strong></a></p>
