...
<?php /*?><?php include('../includes/salida2.php');?>
...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0" class="bordes">
  ...
  <tr>
    ...
    <strong><p id="raqueo">&raquo <a id="guia_titulos" href="../login.php">Inicio</a> / <a id="guia_titulos" href="../novedades/index.php">M&oacute;dulo de Noticia</a> / <a id="guia_titulos" href="#">Detalles</a></p></strong>
          <p class="titles">&raquo; M&oacute;dulo de Noticia / Detalles</p>
...
<?php if ($totalRows_rsFotos>0) {
          ...
          <tr>
            <td height="11" colspan="2" align="left" bgcolor="#EBEBEB"><a href="editar.php?id_not=<?php echo $row_rsProducto['Id_Noticia']; ?>" class="fuente linksRojo"><strong>EDITAR ESTE NOTICIA</strong></a></td>
            </tr>
          <tr>
      ...
      <p><a href="index.php" class="fuente linksRojo"><strong>&laquo; Volver al Listado de Noticias</strong></a></p>
