...
if (isset($_POST['usuario_Txt'])) {
 ...
 // $MM_redirectLoginSuccess = "index.php?login=$id_usu";
  ...
  $LoginRS__query=sprintf("SELECT * FROM usuarios WHERE Estado_Usu = 1 AND (IdNivel_Usu=3)  AND Usern_Usu=%s AND Passw_Usu=%s",
  ...
  if ($loginFoundUser) {
    ...
    $_SESSION['MM_arica_cli'] = $loginUsers['Usern_Usu'];
    $_SESSION['MM_UserGroup_cli'] = $loginUsers['IdNivel_Usu'];
	$_SESSION['MM_IdUser_cli'] = $loginUsers['Id_Usuario'];
	$_SESSION['MM_IdPersona'] = $loginUsers['IdPersona_Usu'];
	$_SESSION['MM_IdNivel'] = $loginUsers['IdNivel_Usu'];
	$id_usu=$_SESSION['MM_IdUser_cli'];
	$MM_redirectLoginSuccess = "index.php?login=$id_usu";
